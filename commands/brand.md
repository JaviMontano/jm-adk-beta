---
name: brand
description: "Branded output: /brand <html|docx|xlsx|folio> <source.md> — Sofka DS tokens from references/brand/"
...
**Gate (brand FIRST).** Resolve Sofka vs MetodologIA vs JM Labs BEFORE rendering — never mix two brands in one artifact; ask if unstated. [EXPLICIT]
