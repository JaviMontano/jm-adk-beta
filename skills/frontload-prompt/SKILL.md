...
version: 0.1.0
description: "Reformatea un input largo o ambiguo a estructura SPEC antes de procesarlo."
owner: "JM Labs"
triggers:
  - frontload-prompt
  - estructurar-input
...
Reformat long/ambiguous input into: **S**ituation · **P**urpose · **E**xpectations (output shape, constraints) · **C**ontext (files, audience, evidence). Surface `{VACIO_CRITICO}` if a required field is missing before processing.
