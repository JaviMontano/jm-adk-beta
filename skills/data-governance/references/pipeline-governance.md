...
Enforce phase gates (G0-G3) and quality checkpoints between pipeline stages. This is an orchestration-layer skill used internally by Pristino and the adk-orchestrator. Protocol details in PRISTINO.md.
